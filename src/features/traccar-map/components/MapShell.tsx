...
interface MapShellContextType {
  isCollapsed: boolean;
}

const MapShellContext = createContext<MapShellContextType>({ isCollapsed: false });

export const useMapShellContext = () => useContext(MapShellContext);
