...
// Componente interno que se desmonta/remonta con key para resetear estado
function DisponibilidadContent({ vehiculo, onClose }: { vehiculo: VehiculoAlquilerDto; onClose: () => void }) {
  ...
  }, [vehiculo, currentMonth, currentYear]);
...
export function DisponibilidadModal({ isOpen, vehiculo, onClose }: DisponibilidadModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="md">
      {/* key fuerza remount al cambiar vehículo, reseteando mes/año automáticamente */}
      <DisponibilidadContent key={vehiculo.id} vehiculo={vehiculo} onClose={onClose} />
    </Modal>
  );
}
